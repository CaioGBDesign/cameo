    ...
    return (
        <div className={styles.dadosPessoais}>
            ...
            <div className={styles.formDadosPessoais}>
                ...
                <BotaoSecundario textoBotaoSecundario={"Redefinir senha"} typeBsecundario={"submit"} idBsecundario={"redefinirSenha"} />
                <SelectInfo idSelect="genero" nameSelect="genero" titulo="Com qual gênero você se identifica?" opcoes={selectGenero} />
                <SelectInfo idSelect="estiloCinefilo" nameSelect="estiloCinefilo" titulo="Estilo cinéfilo" opcoes={estiloCinefilo} />
            </div>

            <BaseBotoes botaoSecundario={false} />

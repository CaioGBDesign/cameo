...
const STATUS_CONFIG = {
  ...
  agendado:  { label: "Agendado",  className: styles.statusAgendado,  Icon: StatusAgendadoIcon  },
  arquivado: { label: "Arquivado", className: styles.statusArquivado, Icon: StatusArquivadoIcon },
};

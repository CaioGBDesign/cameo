...
import DesafioModal from "@/components/desafio/modal";
...
export default function DesafioPage({
  ...
  return (
    <>
      ...
      <Footer />
      <DesafioModal isOpen={modalRegras} onClose={() => setModalRegras(false)}>
        <div className={styles.contentModal}>
          ...
          <div className={styles.topoRegras}>
            <h1>
              Regras da <span>Cameo desafio</span>
            </h1>

            <p>
              Tudo o que você precisa saber para jogar, evoluir e se tornar uma
              referência no universo do cinema, das séries e da dublagem.
            </p>
          </div>

          <div className={styles.sectionRegras}>
            <div className={styles.tituloRegra}>
              <div className={styles.numeroRegra}>
                <span>1</span>
              </div>
            ...
            <p>
              A Cameo Desafio é o espaço da Cameo feito para quem leva cinema a
              sério — ou quer levar. Aqui você responde perguntas, participa de
              desafios temáticos, cumpre metas e acumula XP para evoluir na
              plataforma.
            </p>
            <p>
              Cada desafio é uma chance de testar o quanto você realmente sabe
              sobre os temas que ama. Quanto mais você joga, mais você avança.
            </p>
          </div>
          ...
          <div className={styles.sectionRegras}>
            ...
            <p>
              Escolha um desafio disponível e responda às perguntas. Cada
              pergunta pertence a um tema e tem um nível de dificuldade.
            </p>
            ...
            <p>
              As perguntas da Cameo Desafio podem ter três níveis de
              dificuldade:
            </p>
              ...
              <div className={styles.boxRegra}>
                <div className={styles.conteudoDificuldade}>
                  ...
                  <div className={styles.boxJoia}>
                    <JoiaRosaIcon width={24} height={33} />
                  </div>
                </div>
              </div>
              <div className={styles.boxRegra}>
          ...
          <div className={styles.sectionRegras}>
            ...
            <p>
              O XP é a moeda da sua evolução na Cameo. Existem quatro formas
              principais de acumulá-lo.
            </p>
            ...
            <div className={styles.contentXP}>
              <div className={styles.contentXPBox}>
                ...
                <div className={styles.boxXPDescricao}>
                  ...
                  <p>
                    Cada pergunta correta vale XP de acordo com a dificuldade.
                    Perguntas difíceis rendem mais — mas exigem mais
                    conhecimento.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.contentXPBox}>
                ...
                <div className={styles.boxXPDescricao}>
                  ...
                  <p>
                    De vez em quando, palavras secretas são escondidas pela
                    plataforma. Quem as encontra é recompensado com XP bônus —
                    vale prestar atenção nos detalhes.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.contentXPBox}>
                ...
                <div className={styles.boxXPDescricao}>
                  <p>Cumprindo metas</p>
                  <p>
                    A Cameo oferece metas diárias, semanais, mensais e anuais.
                    Completá-las garante XP extras e mantém sua jornada ativa.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.contentXPBox}>
                ...
                <div className={styles.boxXPDescricao}>
                  ...
                  <p>
                    Eventos temáticos por tempo limitado trazem desafios
                    exclusivos, missões especiais e recompensas únicas que não
                    aparecem no modo comum.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={styles.sectionRegras}>
            ...
            <p>
              As patentes mostram o quanto você conhece cada tema — e cada tema
            ...
            <div className={styles.containerPatentes}>
              <h2>Como funciona</h2>
              <p>
                Todo jogador começa sem nenhuma patente. Você não entra na Cameo
                com um título. Sua primeira patente aparece quando você joga o
                primeiro desafio de um tema específico — a partir daí, você se
                torna Aspirante daquele tema e sua progressão começa.
              </p>
              <p>
                As patentes são independentes por tema. Isso significa que você
                pode ser Lenda do Terror e ainda ser Aspirante de Comédia ao
                mesmo tempo. Progredir em um tema não interfere nos outros. Cada
                um tem seu próprio XP e sua própria escala.
              </p>
            </div>

            <p>
              A progressão é sempre a mesma sequência de 10 níveis, com o nome
              do tema acrescentado ao título:
            </p>
            ...
            <div className={styles.contentPatentesRegras}>
              {[
                ...
                <div key={nivel} className={styles.BoxPatenteRegras}>
                  ...
                  >
                    <path
                      d="M0 16.9768V40.8152C0 42.6226 0.967859 44.2923 2.53899 45.1956L23.2614 57.1145C24.8325 58.0178 26.7675 58.0178 28.3386 57.1145L49.061 45.1956C50.6321 44.2923 51.6 42.6219 51.6 40.8152V16.9768C51.6 15.1694 50.6321 13.4997 49.061 12.5964L28.3386 0.677505C26.7675 -0.225835 24.8325 -0.225835 23.2614 0.677505L2.53899 12.5964C0.967859 13.4997 0 15.1701 0 16.9768Z"
                      fill="#161216"
                    />
                    <path
                      d="M25.7997 55.6893C25.2794 55.6893 24.7664 55.5523 24.3159 55.2935L3.59355 43.3746C2.67881 42.8483 2.10974 41.8674 2.10974 40.8147V16.9762C2.10974 15.9235 2.67809 14.9426 3.59355 14.4163L24.3159 2.49741C24.7664 2.23859 25.2794 2.10156 25.7997 2.10156C26.3201 2.10156 26.8331 2.23859 27.2835 2.49741L48.0059 14.4163C48.9207 14.9426 49.4897 15.9235 49.4897 16.9762V40.8147C49.4897 41.8674 48.9214 42.8483 48.0059 43.3746L27.2835 55.2935C26.8331 55.5523 26.3201 55.6893 25.7997 55.6893ZM25.7997 2.24584C25.3049 2.24584 24.8173 2.37634 24.3887 2.62211L3.66632 14.541C2.79598 15.0412 2.25528 15.9743 2.25528 16.9755V40.814C2.25528 41.8152 2.79598 42.7475 3.66632 43.2485L24.3887 55.1673C24.8173 55.4138 25.3049 55.5436 25.7997 55.5436C26.2946 55.5436 26.7822 55.4131 27.2108 55.1673L47.9332 43.2485C48.8035 42.7482 49.3442 41.8152 49.3442 40.814V16.9755C49.3442 15.9743 48.8035 15.0419 47.9332 14.541L27.2108 2.62211C26.7822 2.37561 26.2946 2.24584 25.7997 2.24584Z"
                      fill="#2F2B2F"
                    />
                    <path
                      d="M22.7601 54.314L24.3531 55.2304C24.7926 55.4834 25.2926 55.6168 25.8005 55.6168C26.3085 55.6168 26.8084 55.4834 27.2479 55.2304L28.8409 54.314H22.7609H22.7601Z"
                      fill="#2F2B2F"
                    />
                    <path
                      d="M28.9042 3.51361L27.2472 2.56025C26.8076 2.30723 26.3077 2.17383 25.7997 2.17383C25.2918 2.17383 24.7919 2.30723 24.3523 2.56025L22.6953 3.51361H28.9034H28.9042Z"
                      fill="#2F2B2F"
                    />
                  </svg>
                  <span>{nivel}</span>
          ...
          <div className={styles.sectionIdeia}>
            <div className={styles.sectionIdeiaSVG}>
              ...
              >
                <path
                  d="M6.08938 15C5.71097 14.1494 5.5 13.2031 5.5 12.2059C5.5 8.50233 8.41015 5.5 12 5.5C15.5899 5.5 18.5 8.50233 18.5 12.2059C18.5 13.2031 18.289 14.1494 17.9106 15"
                  stroke="#1AF5EB"
                  stroke-width="1.5"
                  stroke-linecap="round"
                />
                ...
                />
                <path
                  d="M19.0703 4.92871L18.3632 5.63582"
                  stroke="#1AF5EB"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M5.63668 5.6368L4.92957 4.92969"
                  stroke="#1AF5EB"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M14.5161 19.3064C15.5264 18.9796 15.9316 18.0548 16.0456 17.1246C16.0797 16.8467 15.851 16.6162 15.571 16.6162L8.47587 16.6164C8.18627 16.6164 7.95369 16.8622 7.98827 17.1497C8.09992 18.0781 8.38173 18.7562 9.45247 19.3064M14.5161 19.3064C14.5161 19.3064 9.62874 19.3064 9.45247 19.3064M14.5161 19.3064C14.3946 21.2514 13.8328 22.0217 12.0058 22.0001C10.0516 22.0362 9.60206 21.0841 9.45247 19.3064"
                  stroke="#1AF5EB"
                  stroke-width="1.5"
                  stroke-linecap="round"
                  stroke-linejoin="round"
            ...
            <span>
              O nome do tema sempre faz parte do título. Por exemplo:{" "}
              <strong>
                Conhecedor de Drama, Mestre da Dublagem, Lenda do Terror.
              </strong>{" "}
              Sua patente é o reflexo direto da sua dedicação a cada universo.
            </span>
          </div>
          ...
          <div className={styles.sectionRegras}>
            ...
            <p>
              Além dos desafios comuns, a Cameo lança eventos por tempo limitado
              com temas, missões e recompensas exclusivas.
            </p>
            <p>
              Cada evento tem regras, perguntas e recompensas próprias. Fique de
              olho nas novidades da plataforma para não perder nenhum.
            </p>
          </div>
          ...
          <div className={styles.sectionFinal}>
            ...
            <p>
              Escolha um tema, responda seu primeiro desafio e desbloqueie sua
              primeira patente. A Cameo Desafio espera por você.
            </p>
          </div>
        </div>
      </DesafioModal>

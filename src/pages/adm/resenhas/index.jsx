...
const IconRascunho = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
    <path d="M4 3.5H8" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M4 5.5H6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M6.5 10.75V10.5C6.5 9.0858 6.5 8.3787 6.93935 7.93935C7.3787 7.5 8.0858 7.5 9.5 7.5H9.75M10 6.67155V5C10 3.11438 10 2.17158 9.4142 1.58579C8.82845 1 7.8856 1 6 1C4.11439 1 3.17157 1 2.58578 1.58579C2 2.17157 2 3.11438 2 5V7.2721C2 8.8946 2 9.70585 2.44303 10.2554C2.53254 10.3664 2.63365 10.4674 2.74466 10.5569C3.29415 11 4.10541 11 5.7279 11C6.0807 11 6.25705 11 6.4186 10.943C6.4522 10.9311 6.4851 10.9175 6.51725 10.9022C6.6718 10.8282 6.7965 10.7035 7.04595 10.4541L9.4142 8.0858C9.70325 7.79675 9.84775 7.65225 9.9239 7.46845C10 7.2847 10 7.0803 10 6.67155Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const IconAgendado = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
    <path d="M10.5 5.75C10.5 3.51083 10.5 2.39124 9.8044 1.69562C9.10875 1 7.98915 1 5.75 1C3.51083 1 2.39124 1 1.69562 1.69562C1 2.39124 1 3.51083 1 5.75C1 7.98915 1 9.10875 1.69562 9.8044C2.36486 10.4736 3.42651 10.499 5.5 10.5" stroke="currentColor" strokeLinecap="round"/>
    <path d="M1 3.5H10.5" stroke="currentColor" strokeLinecap="round"/>
    <path d="M5 8H5.75M3 8H3.5M5 6H8M3 6H3.5" stroke="currentColor" strokeLinecap="round"/>
    <path d="M10.6317 7.43586C10.1811 6.93256 9.91076 6.96251 9.61041 7.05241C9.40016 7.08236 8.67926 7.92111 8.37891 8.18826C7.88571 8.67391 7.39031 9.17396 7.35766 9.23921C7.26426 9.39051 7.17741 9.65861 7.13536 9.95816C7.05726 10.4075 6.90206 10.8908 7.08731 10.9567C7.17741 11.0765 7.62796 10.9168 8.07851 10.8509C8.37891 10.7969 8.58916 10.737 8.73936 10.6472C8.94961 10.5213 9.34006 10.078 10.0129 9.41896C10.4349 8.97606 10.8419 8.67001 10.9621 8.37046C11.0822 7.92111 10.902 7.68146 10.6317 7.43586Z" stroke="currentColor" strokeLinecap="round"/>
  </svg>
);

const IconPublicado = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
    <path d="M7.49023 3.50781C7.49023 3.50781 7.74023 3.75781 7.99023 4.25781C7.99023 4.25781 8.78433 3.00781 9.49023 2.75781" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M4.99743 1.0107C3.74819 0.957812 2.78306 1.10172 2.78306 1.10172C2.17364 1.1453 1.00573 1.48696 1.00574 3.4823C1.00575 5.46068 0.99282 7.89968 1.00574 8.87198C1.00574 9.46603 1.37355 10.8517 2.64663 10.9259C4.19405 11.0162 6.98137 11.0354 8.26022 10.9259C8.60257 10.9066 9.74232 10.6379 9.88657 9.39783C10.036 8.11318 10.0063 7.22038 10.0063 7.00788" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M11 3.50781C11 4.88852 9.87963 6.00783 8.49758 6.00783C7.11553 6.00783 5.99518 4.88852 5.99518 3.50781C5.99518 2.1271 7.11553 1.00781 8.49758 1.00781C9.87963 1.00781 11 2.1271 11 3.50781Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M3.49023 6.50781H5.49022" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M3.49023 8.50781H7.49022" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const IconArquivado = () => (
  <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
    <path d="M2 6.0002V7.2723C2 8.8948 2 9.70605 2.44303 10.2556C2.53254 10.3666 2.63365 10.4677 2.74466 10.5572C3.29415 11.0002 4.10541 11.0002 5.7279 11.0002C6.0807 11.0002 6.25705 11.0002 6.4186 10.9432C6.4522 10.9314 6.4851 10.9177 6.51725 10.9024C6.6718 10.8285 6.7965 10.7037 7.04595 10.4543L9.4142 8.086C9.70325 7.79695 9.84775 7.65245 9.9239 7.4687C10 7.2849 10 7.08055 10 6.6718V5.0002C10 3.1146 10 2.17179 9.4142 1.586C8.88465 1.05642 8.06325 1.00561 6.51725 1.00073M6.5 10.7502V10.5002C6.5 9.086 6.5 8.3789 6.93935 7.93955C7.3787 7.5002 8.0858 7.5002 9.5 7.5002H9.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M2 4.11514V2.73053C2 1.77465 2.7835 0.999756 3.75 0.999756C4.7165 0.999756 5.5 1.77465 5.5 2.73053V4.63437C5.5 5.1123 5.10825 5.49975 4.625 5.49975C4.14175 5.49975 3.75 5.1123 3.75 4.63437V2.73053" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const STATUS_CONFIG = {
  publicado: { label: "Publicado", className: styles.statusPublicado, Icon: IconPublicado },
  rascunho:  { label: "Rascunho",  className: styles.statusRascunho,  Icon: IconRascunho  },
  agendado:  { label: "Agendado",  className: styles.statusAgendado,  Icon: IconAgendado  },
  arquivado: { label: "Arquivado", className: styles.statusArquivado, Icon: IconArquivado },
};

const calcularPrioridade = (resenha) => {
  if (!resenha.status || resenha.status.toLowerCase() === "publicado") return { label: "S/P", nivel: 0 };
  const ref = resenha.dataRascunho || resenha.dataPublicacao;
  if (!ref) return { label: "S/P", nivel: 0 };
  const dias = Math.floor((Date.now() - ref.toDate().getTime()) / (1000 * 60 * 60 * 24));
...
const tempoRelativo = (timestamp) => {
  if (!timestamp) return "—";
  const dias = Math.floor((Date.now() - timestamp.toDate().getTime()) / (1000 * 60 * 60 * 24));
    ...
    {[1, 2, 3, 4, 5, 6].map((i) => (
      <span
        ...
        className={`${styles.bar} ${
          nivel === 1 && i <= 2 ? styles.barAtivo :
          nivel === 2 && i <= 4 ? styles.barAtivo :
          nivel === 3 && i <= 6 ? styles.barAtivo : ""
        }`}
      />
    ))}
  </span>
...
const StatusBadge = ({ status }) => {
  const config = STATUS_CONFIG[status?.toLowerCase()] || STATUS_CONFIG.publicado;
  const { Icon } = config;
  return (
...
export default function AdmResenhas() {
  ...
  useEffect(() => {
    const fetchResenhas = async () => {
      try {
        const snap = await getDocs(collection(db, "criticas"));
  ...
  const executarDeletar = async () => {
    ...
    await deleteDoc(doc(db, "criticas", confirmarDeletar.id));
  ...
  const atualizarLocal = (id, changes) =>
    setResenhas((prev) => prev.map((r) => r.id === id ? { ...r, ...changes } : r));

  const removerLocal = (id) =>
    setResenhas((prev) => prev.filter((r) => r.id !== id));

  const handleAcao = async (acao, resenha) => {
    setMenuAberto(null);
    const docRef = doc(db, "criticas", resenha.id);

    switch (acao) {
      case "editar":
        router.push(`/adm/resenhas/editar/${resenha.id}`);
        break;

      case "visualizar": {
        const status = resenha.status?.toLowerCase() || "publicado";
        const url = status === "publicado"
          ? `/resenhas/detalhes/${resenha.id}`
          : `/resenhas/detalhes/${resenha.id}?preview=true`;
        window.open(url, "_blank");
        break;
      }

      case "duplicar": {
        const novoId = `${resenha.id}-copia-${Date.now()}`;
        const { id: _id, ...resto } = resenha;
        await setDoc(doc(db, "criticas", novoId), {
          ...resto,
          titulo: `${resenha.titulo} (cópia)`,
          status: "rascunho",
      ...
      case "publicar":
        await updateDoc(docRef, { status: "publicado", dataPublicacao: serverTimestamp() });
        atualizarLocal(resenha.id, { status: "publicado" });
        break;

      case "cancelar_agendamento":
        await updateDoc(docRef, { status: "rascunho" });
        atualizarLocal(resenha.id, { status: "rascunho" });
        break;
      ...
      case "arquivar":
        await updateDoc(docRef, { status: "arquivado" });
        atualizarLocal(resenha.id, { status: "arquivado" });
        break;
  ...
  const resenhasFiltradas = resenhas.filter((r) => {
    if (filtroStatus && (r.status?.toLowerCase() || "publicado") !== filtroStatus) return false;
    if (filtroTitulo && !r.titulo?.toLowerCase().includes(filtroTitulo.toLowerCase())) return false;
    if (filtroPrioridade !== null && calcularPrioridade(r).nivel !== filtroPrioridade) return false;
    return true;
  });

  const resenhasOrdenadas = aplicarSort(resenhasFiltradas, sortCol, sortDir);

  const totalPaginas = Math.ceil(resenhasOrdenadas.length / POR_PAGINA);
  const resenhasPagina = resenhasOrdenadas.slice(
    (pagina - 1) * POR_PAGINA,
    pagina * POR_PAGINA,
  );
  ...
  const headerActions = (
    <Button
      ...
      label="Criar resenha"
      type="button"
      onClick={() => router.push("/adm/resenhas/criar")}
  ...
  return (
    <AdmLayout headerActions={headerActions}>
      <Head>
        <title>Cameo ADM — Resenhas</title>
      </Head>
        ...
        <div className={styles.popoverOverlay} onClick={() => setConfirmarDeletar(null)}>
          <div className={styles.popover} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.popoverAcoes}>
              <button type="button" className={styles.popoverCancelar} onClick={() => setConfirmarDeletar(null)}>
                Cancelar
              </button>
              <button type="button" className={styles.popoverConfirmar} onClick={executarDeletar}>
      ...
      {menuAberto && (() => {
        const resenha = resenhas.find((r) => r.id === menuAberto);
        if (!resenha) return null;
        const status = resenha.status?.toLowerCase() || "publicado";
                  ...
                  {grupo.map((acao) => {
                    ...
                    return (
                      <button
                        ...
                        onClick={() => handleAcao(acao, resenha)}
                      >
      ...
      <div className={styles.page}>
        <div className={styles.pageHeader}>
          <h1 className={styles.pageTitulo}>Todas as resenhas</h1>
          {temFiltros && (
        ...
        {loading ? (
          ...
          <p className={styles.empty}>Nenhuma resenha encontrada.</p>
        ) : (
          <>
            <div className={styles.tableWrapper}>
              <table className={styles.table}>
                ...
                <tbody>
                  {resenhasPagina.length === 0 ? (
                    <tr>
                      <td colSpan={7} style={{ textAlign: "center" }} className={styles.empty}>
                        Nenhuma resenha encontrada com os filtros aplicados.
                      </td>
                    </tr>
                  ) : resenhasPagina.map((resenha) => {
                    const prioridade = calcularPrioridade(resenha);
                    const criadoEm = resenha.dataRascunho || resenha.dataPublicacao;
                    const editadoEm = resenha.dataPublicacao || resenha.dataRascunho;
                    return (
                      <tr
                        key={resenha.id}
                        className={styles.trClicavel}
                        onClick={() => router.push(`/adm/resenhas/editar/${resenha.id}`)}
                      >
                        <td className={styles.colTitulo}>
                          <span className={styles.titulo}>{resenha.titulo}</span>
                        </td>
                        <td>
                          <StatusBadge status={resenha.status} />
                        </td>
                        <td>
                          {resenha.autor?.avatarUrl ? (
                            <img src={resenha.autor.avatarUrl} alt={resenha.autor.nome} className={styles.avatar} title={resenha.autor.nome} />
                          ) : (
                            <span className={styles.avatarFallback}>{resenha.autor?.nome?.[0] ?? "?"}</span>
                          )}
                        </td>
                        ...
                        <td>
                          <span className={styles.prioridade}>
                            ...
                            <span className={styles.prioridadeLabel}>{prioridade.label}</span>
                          </span>
                        </td>
                        <td className={styles.colAcoes} onClick={(e) => e.stopPropagation()}>
                          <button type="button" className={styles.btnAcoes} onClick={(e) => abrirMenu(resenha.id, e)}>
                            •••
                          </button>
                        </td>
                      </tr>
            ...
            {totalPaginas > 1 && (
              <div className={styles.paginacao}>
                <span className={styles.paginacaoInfo}>
                  {(pagina - 1) * POR_PAGINA + 1}–{Math.min(pagina * POR_PAGINA, resenhasOrdenadas.length)} de {resenhasOrdenadas.length}
                </span>
                  ...
                  {Array.from({ length: totalPaginas }, (_, i) => i + 1)
                    ...
                    .map((item, idx) =>
                      item === "..." ? (
                        ...
                        <button key={item} type="button" className={`${styles.btnPagina} ${item === pagina ? styles.btnPaginaAtivo : ""}`} onClick={() => setPagina(item)}>
                          {item}
                        </button>
                      ),
                    )}

...
export default function Tipo3({ id = null, initialData = null }) {
    ...
    const timer = setTimeout(async () => {
      ...
      try {
        ...
        if (data.release_date)
          setAnoLancamento(data.release_date.split("-")[0]);
  ...
  const sidebar = (
    <div className={styles.sidebarContent}>
      <TextInput
        ...
        placeholder='Ex: "Em que ano foi lançado?"'
        value={titulo}
        onChange={(e) => {
      ...
      <TextInput
        label="Subtítulo"
        placeholder='Ex: "Você sabe o ano?"'
        value={subtitulo}
        onChange={(e) => {
    ...
    <div className={styles.previewWrapper}>
      <div className={styles.previewCard}>
        ...
        <div className={styles.previewAnoWrapper}>
          {loadingFilme ? (
            <span className={styles.previewAnoPlaceholder}>...</span>
          ) : anoLancamento ? (
            <span className={styles.previewAno}>{anoLancamento}</span>
          ) : (
            <span className={styles.previewAnoPlaceholder}>

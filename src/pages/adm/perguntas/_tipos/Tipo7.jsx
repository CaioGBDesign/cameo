...
export default function Tipo7({ id = null, initialData = null }) {
  ...
  const [cronometroAtivo, setCronometroAtivo] = useState(initialData?.cronometroAtivo ?? false);
      ...
      <div className={styles.previewCard}>
        <div className={styles.previewHeader}>
          {titulo
            ...
            : <h2 className={`${styles.previewTitle} ${styles.previewPlaceholder}`}>Título da pergunta</h2>}
